...
class Ui_PaginaScontrini(object):
    def setupUi(self, PaginaScontrini):
        ...
        PaginaScontrini.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiScontrini/SfondoScontrini.png);")
        ...
        self.ButtonAggiungiScontrini.setStyleSheet("background-position: center;\n"
                                                   "background-image: url(ImmaginiProgetto/ImmaginiScontrini/ButtonAggiungiScontrini.png);\n"
        ...
        self.ButtonCercaScontrini.setStyleSheet("background-position: center;\n"
                                                "background-image: url(ImmaginiProgetto/ImmaginiScontrini/ButtonCercaScontrini.png);\n"
                                                "border: 2px solid black;\n"
                                                "border-radius: 10px;\n"
                                                "border-color: #20730b;")
        ...
        self.ButtonHome.setStyleSheet("background-position: center;\n"
                                      "background-image: url(ImmaginiProgetto/ImmaginiScontrini/ButtonHome.png);\n"
                                      "border: 2px solid black;\n"
                                      "border-radius: 10px;\n"
                                      "border-color: #20730b;")
