...
class Ui_PaginaProdotti(object):
    def setupUi(self, PaginaProdotti):
        ...
        PaginaProdotti.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiProdotto/SfondoProdotti.png);")
        ...
        self.ButtonCerca.setStyleSheet("background-position: center;\n"
                                       "background-image: url(ImmaginiProgetto/ImmaginiProdotto/ButtonCercaProdotti.png);\n"
        ...
        self.ButtonHome.setStyleSheet("background-position: center;\n"
                                      "background-image: url(ImmaginiProgetto/ImmaginiProdotto/ButtonHome.png);\n"
                                      "border: 2px solid black;\n"
                                      "border-radius: 10px;\n"
                                      "border-color: #20730b;")
        ...
        self.ButtonAggiungiSconto.setStyleSheet("background-position: center;\n"
                                                "background-image: url(ImmaginiProgetto/ImmaginiProdotto/ButtonAggiungiSconti.png);\n"
                                                "border: 2px solid black;\n"
                                                "border-radius: 10px;\n"
                                                "border-color: #20730b;")
