...
class Ui_PaginaPersonale(object):
    def setupUi(self, PaginaPersonale):
        ...
        PaginaPersonale.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiPersonale/SfondoPersonale.png);")
        ...
        self.ButtonAggiungiPersonale.setStyleSheet("background-position: center;\n"
                                                   "background-image: url(ImmaginiProgetto/ImmaginiPersonale/ButtonAggiungiPersonale.png);\n"
        ...
        self.ButtonRimuoviPersonale.setStyleSheet("background-position: center;\n"
                                                  "background-image: url(ImmaginiProgetto/ImmaginiPersonale/ButtonRimuoviPersonale.png);\n"
                                                  "border: 2px solid black;\n"
                                                  "border-radius: 10px;\n"
                                                  "border-color: #20730b;")
        ...
        self.ButtonCercaPersonale.setStyleSheet("background-position: center;\n"
                                                "background-image: url(ImmaginiProgetto/ImmaginiPersonale/ButtonCercaPersonale.png);\n"
                                                "border: 2px solid black;\n"
                                                "border-radius: 10px;\n"
                                                "border-color: #20730b;")
        ...
        self.ButtonModificaPermessi.setStyleSheet("background-position: center;\n"
                                                  "background-image: url(ImmaginiProgetto/ImmaginiPersonale/ButtonModificaPermessi.png);\n"
                                                  "border: 2px solid black;\n"
                                                  "border-radius: 10px;\n"
                                                  "border-color: #20730b;")
        ...
        self.ButtonHomePersonale.setStyleSheet("background-position: center;\n"
                                               "background-image: url(ImmaginiProgetto/ImmaginiPersonale/ButtonHome.png);\n"
                                               "border: 2px solid black;\n"
                                               "border-radius: 10px;\n"
                                               "border-color: #20730b;")
