...
class Ui_ErroreSconto(object):
    def setupUi(self, ErroreSconto):
        ErroreSconto.setObjectName("Errore")
        ErroreSconto.resize(487, 122)
        self.ButtonIndietro = QtWidgets.QPushButton(ErroreSconto)
        ...
        self.labelDNMerrore = QtWidgets.QLabel(ErroreSconto)
        ...
        self.labelNomeErrore = QtWidgets.QLabel(ErroreSconto)
        ...
        self.labelDescrizioneErrore = QtWidgets.QLabel(ErroreSconto)
        ...
        self.retranslateUi(ErroreSconto)
        QtCore.QMetaObject.connectSlotsByName(ErroreSconto)
    ...
    def retranslateUi(self, Errore):
        ...
        self.labelNomeErrore.setText(_translate("Errore", "CODICE PRODOTTO MANCANTE"))
        self.labelDescrizioneErrore.setText(_translate("Errore", "Il codice del prodotto inserito non esiste."))
...
if __name__ == "__main__":
    ...
    ErroreSconto = QtWidgets.QWidget()
    ui = Ui_ErroreSconto()
    ui.setupUi(ErroreSconto)
    ErroreSconto.show()
    sys.exit(app.exec_())