...
class Ui_ErroreCodiceOrdine(object):
    ...
    def retranslateUi(self, Errore):
        ...
        self.labelNomeErrore.setText(_translate("Errore", "CODICE ORDINE ERRATO"))
        self.labelDescrizioneErrore.setText(_translate("Errore", "Il codice dell'ordine inserito non esiste."))
