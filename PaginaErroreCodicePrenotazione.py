...
class Ui_ErroreCodicePrenotazione(object):
    ...
    def retranslateUi(self, Errore):
        ...
        self.labelNomeErrore.setText(_translate("Errore", "CODICE PRENOTAZIONE ERRATO"))
        self.labelDescrizioneErrore.setText(_translate("Errore", "Il codice della prenotazione inserito non esiste."))
...
if __name__ == "__main__":
    ...
    ui = Ui_ErroreCodicePrenotazione()
    ui.setupUi(Errore)
    Errore.show()
    sys.exit(app.exec_())