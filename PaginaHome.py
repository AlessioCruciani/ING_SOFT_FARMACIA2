...
class Ui_HomePage(object):
        def setupUi(self, HomePage):
                ...
                HomePage.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/SfondoHomePage.png);\n"
                ...
                self.ButtonMagazzino.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonMagazzino.png);\n"
                ...
                self.ButtonScontrini.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonScontrini.png);\n"
                                                   "border: 2px solid black;\n"
                                                   "border-radius: 10px;\n"
                                                   "border-color: #20730b;")
                ...
                self.ButtonHome.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonLogout.png);\n"
                                              "border: 2px solid black;\n"
                                              "border-radius: 10px;\n"
                                              "border-color: #20730b;")
                ...
                self.ButtoOrdini.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonOrdini.png);\n"
                                               "border: 2px solid black;\n"
                                               "border-radius: 10px;\n"
                                               "border-color: #20730b;")
                ...
                self.ButtonDipendenti.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonDipendenti.png);\n"
                                                    "border: 2px solid black;\n"
                                                    "border-radius: 10px;\n"
                                                    "border-color: #20730b;")
                ...
                self.ButtonPrenotazioni.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonPrenotazioni.png);\n"
                                                      "border: 2px solid black;\n"
                                                      "border-radius: 10px;\n"
                                                      "border-color: #20730b;")
                ...
                self.ButtonFidelity.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonFidelity.png);\n"
                                                  "border: 2px solid black;\n"
                                                  "border-radius: 10px;\n"
                                                  "border-color: #20730b;")
                ...
                self.ButtonProdotti.setStyleSheet(
                        "background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonProdotti.png);\n"
                        "border: 2px solid black;\n"
                        "border-radius: 10px;\n"
                        "border-color: #20730b;")
                ...
                self.ButtonStatistiche.setStyleSheet(
                        "background-image: url(ImmaginiProgetto/ImmaginiHome/ButtonStatistiche.png);\n"
                        "border: 2px solid black;\n"
                        "border-radius: 10px;\n"
                        "border-color: #20730b;")
                ...
                self.fakeButton.setStyleSheet(
                        "background-image: url(ImmaginiProgetto/ImmaginiStatistiche/ButtonHome.png);\n"
                        "border: 2px solid black;\n"
                        "border-radius: 10px;\n"
                        "border-color: #20730b;\n"
                        "background-repeat: no-repeat;")
        ...
        def caricaNotifiche(self):
                ...
                if risultatoQueryProdottiInvenduti.__sizeof__()>0:
                        self.fakeButton.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/NotificheConCampana.png);\n"
                                                      "border: 2px solid black;\n"
                                                      "border-radius: 10px;\n"
                                                      "border-color: #20730b;\n"
                                                      "background-repeat: no-repeat;")
                else:
                        self.fakeButton.setStyleSheet("background-image: url(ImmaginiProgetto/ImmaginiHome/NotificheSenzaCampana.png);\n"
                                                      "border: 2px solid black;\n"
                                                      "border-radius: 10px;\n"
                                                      "border-color: #20730b;\n"
                                                      "background-repeat: no-repeat;")
